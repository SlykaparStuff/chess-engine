...
void board_init(Board* board)
{
  ...
  board->bb_piece[bb_piece_white_queen] = 0x1000000000000000; // Initial position of the white queen
  board->bb_piece[bb_piece_black_queen] = 0x0000000000000010; // Initial position of the black queen

  board->bb_piece[bb_piece_white_king] = 0x0800000000000000; // Initial position of the white king
  board->bb_piece[bb_piece_black_king] = 0x0000000000000008; // Initial position of the black king
}
